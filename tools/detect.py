...
def vis_detections(im, classes_name, all_dets, img_path=None, txt_path=None, thresh=0.5):
...
def detect(net, im, classes, img_path, txt_path):
    ...
    vis_detections(im, classes, all_dets, img_path, txt_path, thresh=CONF_THRESH)
...
if __name__ == '__main__':
    ...
    for i in range(len(image_pathes)):
        ...
        detect(net, im, CLASSES[1:], det_image_pathes[i], None)
