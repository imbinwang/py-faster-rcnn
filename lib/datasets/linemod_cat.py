...
#
# this file is writen by Bin Wang(binwangsdu@gmail.com) 2016/2/17
# use Faster R-CNN to detect LINEMOD dataset
# modified by adding pose data at 2016/2/17
#
...
class linemod_cat(datasets.imdb):
